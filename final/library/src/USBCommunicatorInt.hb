...
private:
	 ...
	 * \param operand the speed of the motor, given as a signed percentage
	 */
	void answerWheelL(int8_t operand);
	 ...
	 * \param operand the speed of the motor, given as a signed percentage
	 */
	void answerWheelR(int8_t operand);

	/**
	 * \brief answer a MSG_LED message; catch the operand and change the color 
	 *        accordingly
	 * \param operand the color of the led
	 */
	void answerLed(uint8_t operand);
